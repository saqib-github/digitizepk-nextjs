          ...
          <div className="contact-form">
            ...
            <form onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="col-lg-12 col-sm-12">
                  <div className="form-group">
                    <h2>For How long period you want to hire ?</h2>
                    <input
                      type="text"
                      name="tPeriod"
                      placeholder="[(a) 1 Month]  [(b) 3 Month] [(c) 6 Month]  [ (d) other ]"
                      className="form-control"
