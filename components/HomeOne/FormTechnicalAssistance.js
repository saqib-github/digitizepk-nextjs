...
const ContactFormStyleTwo = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const url = `${baseUrl}/api/technical`;
      const {
        email,
        service,
        type,
        ...
        <div className="contact-wrap contact-pages mb-0">
          <div className="contact-form">
            <div className="section-title">
              <h2>What kind of technical assistance you want ?</h2>
              <select
                name="type"
                value={contact.type}
              ...
              >
                ...
                <option value="Adding New Feature to your app">
                  Adding New Feature to your app
                </option>
                <option value="Start New Project With Us">
